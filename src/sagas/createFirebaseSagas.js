...
export class FirebaseSagas {
  constructor(app) {
    ...
    this.auth = {
      ...
      signInWithPopup: authModule.signInWithPopup.bind(this),
      signInWithGoogle: authModule.signInWithGoogle.bind(this),
      signInWithFacebook: authModule.signInWithFacebook.bind(this),
      signInWithTwitter: authModule.signInWithTwitter.bind(this),
      signInWithGithub: authModule.signInWithGithub.bind(this),
